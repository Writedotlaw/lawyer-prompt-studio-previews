...
with sync_playwright() as pw:
    ...
    def persistence_check():
        ...
        go(p,'#/notebook')
        entry=p.locator('#saved-graph-lesson')
    ...
    report={'checkedAt':datetime.datetime.now(datetime.timezone.utc).isoformat(),'publicUrl':URL,'withoutLogin':True,'storageMocked':False,'routes':routes,
